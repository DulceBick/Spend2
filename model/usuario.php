  ...
  class Usuario extends Conexion
  {
    ...
    public function login($user, $clave)
    {
      ...
      */
      ...
      $consulta = 'select nombre,pass,tipo_acceso from acceso where nombre="'.$user.'" and pass="'.$clave.'"';
      /*
      ...
      */
      ...
      if($verificar_usuario > 0){
        ...
        */
        ...
        $_SESSION['tipo_acceso']  = $user['tipo_acceso'];
        ...
        */
        ...
        if($_SESSION['tipo_acceso'] == 3){
          echo 'view/logistica/logistica.php';
        }else if($_SESSION['tipo_acceso'] == 1){
          echo 'view/vigilancia/vigilancia.php';
        }
    ...
    public function registroUsuario($name, $email, $clave)
    {
      ...
      $verificarCorreo = parent::verificarRegistros('select id_acceso from acceso where nombre="'.$email.'" ');
